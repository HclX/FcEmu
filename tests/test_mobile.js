...
// Mobile-only tests — Pixel 5 landscape device emulation
// Note: Desktop redirect test is in test_desktop.js (separate file
// so this file's test.use() device emulation doesn't affect it)
test.use({
